...
if (isServer == 1) {
  hearMurmers.src =
    url + "/wp-content/uploads/media/btn-play-shared-chronicle.png";
} else {
  hearMurmers.src = "assets/btn-play-shared-chronicle.png";
}
...
jQuery.ajax({
  url: url + "/wp-content/themes/load_shared.php",
